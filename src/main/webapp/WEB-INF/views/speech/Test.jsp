...
<script
	src="https://connect.facebook.net/signals/config/943528292826757?v=2.9.30&amp;r=stable"
	async=""></script>
	...
	<div id="root">
		<div class="ServiceIntro">
			<div class="TopBar undefined">
				<div class="navigation-bar">
					...
					<div class="nav">
						...
						<div class="balloon display">면접 강의를 무제한으로!</div>
						<a class="service-intro current" href="/service-intro">서비스 소개</a><a
							class="help-info false" href="/help-info">도움말</a>
					</div>
				</div>
				<button class="login">시작하기</button>
			</div>
			...
			<div class="hero__content">
				...
				<div class="hero__img">
					<img src="/static/media/hero-laptop.99095523.png" alt="">
				</div>
			</div>
			...
			<div class="content">
				<div class="wrapper">
					<div class="content__img">
						<img src="/static/media/service-laptop1.959a0410.png" alt=""
							class="laptop1">
					</div>
			...
			<div class="content">
				<div class="wrapper">
					<div class="content__img">
						<img src="/static/media/service-laptop2.e0680f4b.png" alt="">
					</div>
					<div class="content__textarea wow fadeInUp">
						<div class="textarea__title">
			...
			<div class="content flip">
				...
				<div class="content__img">
					<img src="/static/media/service-laptop3.17676e1e.png" alt=""
						class="laptop3">
				</div>
			</div>
			</section> <section class="video-analyze">
			<div class="live-video">
				...
				<div class="live-video__interviewing-area">
					...
					<img src="/static/media/service-comment.f5af33af.svg" alt="">
				</div>
			</div>
			</section> <section class="analyze"> <img
				src="/static/media/pc-landing-circles-1.8c1a4b77.png" alt=""
			...
			<div class="analyze-index__content">
				...
				<div class="content__boxs">
					<div class="boxs__box">
						<div class="wrapper">
							<div class="box__icon">
								<img src="/static/media/pc-face-icon-color.c76c2f59.png" alt="">
							</div>
					...
					<div class="boxs__box">
						<div class="wrapper">
							<div class="box__icon">
								<img src="/static/media/pc-voice-icon-color.dad36204.png" alt="">
							</div>
					...
					<div class="boxs__box">
						<div class="wrapper">
							<div class="box__icon">
								<img src="/static/media/pc-word-icon-color.2c2d7dcb.png" alt="">
							</div>
			...
			<div class="analyze-visual__content">
				...
				<div class="content__wrapper">
					<img src="/static/media/pc-face-graph.92ce679a.png" alt="">
				...
				<div class="content__wrapper">
					...
					<img src="/static/media/pc-sight-graph.cbde8eff.png" alt=""
						class="sight-graph">
				</div>
			</div>
			...
			<div class="analyze-voice__content">
				...
				<div class="content__wrapper">
					<div class="wrapper__speech-tempo-box">
						<img src="/static/media/slide_speech-tempo.ba3b5210.svg" alt=""
				...
				<div class="content__wrapper">
					<div class="wrapper__volume-graph-box">
						<img src="/static/media/pc-volume.fc73dfb2.png" alt=""
				...
				<div class="content__wrapper">
					<div class="wrapper__my-answer">
						...
						<div class="my-answer__box">
							<img src="/static/media/profile-circle.15f7caef.png" alt=""
				...
				<div class="content__graphs">
					...
					<div class="graphs__talent">
						<div class="talent__box">
							<img src="/static/media/pc-talent-graph.8b60dfb8.png" alt=""
