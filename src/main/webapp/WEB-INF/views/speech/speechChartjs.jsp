...
<body>
	...
	<div id="root">
				...
				<div class="MainBoard">
					<div class="board">
						<div class="RecentInterview box">
							...
							<a id="result-btn" class="review-btn" href="/analysisresult/interviewresult.do">결과
								보기</a> 
						</div>
						...
						<div class="box HelpArea" id="pronunciation">
							...
							<div class="label"></div>
							 <a class="title">Test</a> &nbsp
								<button class="result-analysis-btn" id="popUpOpenBtn">발음 평가</button>
								<button class="result-analysis-btn" id="speechOpen">스피치 평가</button>
							...
							<div class="nav">
								...
								<div class="select-area">
									<div class="emotion btn select" data-target="emotionChart">
										<div class="pot"></div>
										표정<img src="data:image/png;base64,"
											alt="" class="dash">
									</div>
						...
						<div class="Habitant box" id="habitant">
      ...
      speechOpen.addEventListener("click", () => {
    	  ...
    	  var options = 'top=10, left=10, width=450, height=463, status=no, menubar=no, toolbar=no, resizable=no';
      window.open(url, "", options);
