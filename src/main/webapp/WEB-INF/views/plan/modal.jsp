	...
	$(document).ready(function() {
		...
		$(".review-body").hide();
			...
			$('body').on('click','.close', function() {
				...
				if($(this).attr("class").indexOf("close")){
					$(this).removeClass("close")
					$(this).addClass("open")
					$("#aa").attr("src", "/images/화살표.png");			
					console.log(1)
				}else{
// 					$(this).removeClass("QuestionReview open")
// 					$(this).addClass("QuestionReview close")
// 					console.log(2)
				} 
				$(".review-body ").toggle();
			})
		...
		$('body').on('click','.open',function(){
			...
			$(this).addClass("close")
			$("#aa").attr("src", "/images/data_image_png.png");
			$(".review-body ").toggle();
			console.log(4)
		})
				...
				<div class="title-flex">
					<div class="title-form">
						<input type="text" class="title-text" placeholder="이름 없는 면접"
							maxlength="30" value="1.면접 입니다."> &nbsp &nbsp &nbsp &nbsp
				...
				<div class="review-body" id="review-id">
					...
					<div class="ReviewVideo content-box">
						<div class="review-video-area">
							<img src="/images/calm.e5d1123e.png" class="review-video">
						...
						<div class="AnswerSpeed">
							...
							<div class="content-box slow">
								...
								<div class="average-speed">
									합격자 평균 속도<br> <span>300</span>
								</div>
								<div class="minute-text">
									<span>1분당</span><br> <b>240</b>자
								</div>
					...
					<div class="AudioReview">
						...
						<div class="pitch-graph">
							<div class="user-pitch" style="left: 238px;">
								<img
									src="https://aida-users.s3.ap-northeast-2.amazonaws.com/profile/2324.jpg"
									alt="profile-icon" class="profile-icon"><br> <b>dsfaqwef</b>
								님의 평균 음역대<br> <span>123Hz</span>
								<div class="line"></div>
								<div class="point"></div>
							</div>
							...
							<div class="men-pitch-area">
								<div class="message">
									<b>선호되는 남성</b>의<br>평균 음역대<br> <span>110Hz~130Hz</span>
								</div>
							</div>
							<div class="women-pitch-area">
								<div class="message">
									<b>선호되는 여성</b>의<br>평균 음역대<br> <span>210Hz~240Hz</span>
								</div>
							</div>
						</div>
					</div>
					<div class="EmotionGraph">
						...
						<div class="chracter-flex">
							...
							<img src="/images/happy.b6f96d37.png" alt="character"> <img
								src="/images/calm.e5d1123e.png" alt="character"> <img
								src="/images/dark.cdc202f0.png" alt="character"> <img
								src="/images/surprised.783e5dfe.png" alt="character">
						</div>
					...
					<div class="GazeGraph">
						...
						<div class="message">면접 시 면접관을 응시하는 것이 중요합니다.</div>
						<div class="content-box">
