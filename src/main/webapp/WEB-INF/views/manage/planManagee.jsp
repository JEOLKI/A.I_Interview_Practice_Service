        ...
        <%@ include file="/WEB-INF/views/layout/header.jsp" %>
               ...
               <div class="box">
                  <div class="PaymentBox">
                     ...
                     <div class="content-body">
                        <div class="title regist"><input id="registTitle" type="text" placeholder="이용권 이름을 입력해주세요"></div>
                        <div class="price-area">
                           <div class="date-num">
                              <span><input id="registDateNum" type="text" ></span>일 이용권
                           </div>
                           <div class="price-num">
                              <!-- ₩ 5,900 / 1일 --><br> <span class="price">₩ <input id="registPrice" type="text" placeholder="금액"></span>
                        ...
                        <div class="marketing-message">
                           <div class="point"></div>
                           <div class="txt"><input id="registMessage" type="text" placeholder="설명을 입력해주세요"></div>
                        </div>
                     </div>
                  </div>
                  <button id="registBtn"
                     onclick="location.href='${cp }/plan/registPlan'">등록하기</button>
               </div>
         ...
         <div class="notice">
            ...
            <div class="notice-list">
               - 해당 이용권은 PC에서 무제한으로 면접을 수행할 수 있는 이용권입니다.<br>- 녹화 및 분석된 면접 영상은
               인터넷이 연결된 환경에서 얼마든지 볼 수 있습니다.<br>- 구입하신 이용권은 마이 페이지에서 확인할 수
               있습니다.<br>- 본 이용권의 금액은 부가세 10%가 포함되어 있는 금액입니다.<br>- 본 이용권은
               이용 시작일(구매일) 기준 7일 이내 청약철회 가능한 이용권입니다.<br>&ensp;단, 이용 내역이 있는 경우
               이용 금액 공제 후 환불합니다.<br>- 이용 시작일(구매일) 기준 7일 경과 후에는 *이용 금액 공제 후 해지
               가능합니다.<br>*이용 금액은 이미 경과된 시간(실제 사용 여부 불문)에 상응하는 금액을 말합니다.<br>-
            ...
            <footer class="TransparentFooter">
               <div class="nav-flex">
                  <div class="user-agreement">
                     <a href="/agreement/userAgree">회원이용약관</a>
                  </div>
               ...
               <div class="info">
                  <img src="#" class="doodlin-logo" alt="doodlin-logo">@<b>Doodlin
