...
<body>
		...
		<div class="LandingNew">
				...
				<div class="navigation-bar">
					...
					<div class="nav">
						<a class="main false" href="/main">내 면접</a><a
							class="lecture false" href="/lecture">게시판</a>
			...
			<div class="content intro">
				<div class="content-box">
					...
					<button class="login ">무료 체험하기</button>
				</div>
			...
			<div class="content gray calc">
				...
				<div class="calc-num wow fadeInUp"
					...
					현재 진행중인 면접 수 <span>15,732회</span><img
			...
			<div class="content main">
				<div class="content-box first">
					<div class="message wow fadeInUp"
						style="visibility: visible; animation-name: fadeInUp;">집에서도
						손쉽게 혼자서도 부담없이</div>
				...
				<div class="content-box second">
					...
					<div class="interface">
						...
						<a href="/main" class="service-link green wow fadeInUp"
							style="visibility: visible; animation-name: fadeInUp;">무료
							체험하기<img
							src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAMCAYAAACulacQAAAABHNCSVQICAgIfAhkiAAAAGhJREFUGFd10LERgCAMheEXWnUHmQQ3ESYTNnESHYIePUwBRKCD7z/gQphWC6UM4uUgFmHRHqAdgJcBffEgYBwEBTtBizmY9Qkig5Rci/zzA3gC4m0LCsiXMHaAcQAV0pbf+E9InlT7FwGRLZg1T12ZAAAAAElFTkSuQmCC"
							alt="" class="dash">
						</a>
			...
			<div class="content comment">
				<div class="message wow fadeInUp"
					style="visibility: visible; animation-name: fadeInUp;">아이엠터뷰,
					사용해보니 어떤가요?</div>
	...
	<div id="myModal" class="modal">
      ...
      <div class="modal-content">
                <p style="text-align: center;"><span style="font-size: 14pt;"><b><span style="font-size: 24pt;">당신 옆의<br>면접 트레이너</span></b></span></p>
                <p style="text-align: center; line-height: 1.5;"><br />
               		<form action="">
	                	<div class="input-left">
		                	<span class="input">아이디</span> <input type="text"><br>
		                	<span class="input">비밀번호</span> <input type="text"><br>
	                	</div>
