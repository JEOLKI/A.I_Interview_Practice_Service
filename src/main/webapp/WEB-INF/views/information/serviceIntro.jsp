	...
	<div id="root">
		<%@ include file="/WEB-INF/views/layout/header.jsp" %>
			...
			<div class="content-box first">
				<div class="wrapper">
					...
					<div class="needs-flex">
						<div class="area">
							<div class="box">
								<img src="/images/chrome.90ee9563.svg" alt=""
									class="chrome">
							</div>
						...
						<div class="area">
							<div class="box">
								<img src="/images/PC_laptop.ae8b563b.svg" alt=""
									class="pc">
							</div>
						...
						<div class="big-area">
							...
							<div class="area">
								<div class="box">
									<img src="/images/camera_webcam.650627bc.svg" alt=""
										class="camera">
								</div>
							...
							<div class="area">
								<div class="box">
									<img src="/images/stand_mic.f99d71f2.svg" alt=""
										class="mic">
								</div>
			...
			<div class="live-video">
				...
				<div class="live-video__title wow fadeInUp"
					style="visibility: visible; animation-name: fadeInUp;">실시간
					영상분석</div>
			...
			<div class="analyze">
			<img src="/images/pc-landing-circles-1.8c1a4b77.png" alt=""
				class="circle1">
