...
//			stVo.setMemId(mv.getMemId());
   ...
   @RequestMapping(path="/speechChartjs.do", method = {RequestMethod.GET})
   public String speechChartjsView(Model model) {
	   SpeechVO sv = new SpeechVO();
//		MemberVO mv = (MemberVO) session.getAttribute("S_MEMBER");
//		sv.setMemId(mv.getMemId());
	    sv.setMemId("TEST_ID");
