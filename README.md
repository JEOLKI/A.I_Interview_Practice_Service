...
**인공지능** 모의면접을 통해 사용자의 **음성 및 표정, 언어 데이터**를 분석한 **리포트**를 출력하고, 해당 데이터를 이용하여 사용자의 성장 그래프를 생성합니다.  
성장그래프를 바탕으로 사용자의 부족한 점을 보완하여 면접 스킬을 향상시키는 면접 트레이닝 서비스입니다.  

관리자는 면접 횟수, 매출, 인재상 분포, 요금제 수, 습관어와 반복어의 빈도수 등을 수치화하여 그래프로 한눈에 알아볼 수 있습니다.  
또한. 회원, 게시판, 요금제, 면접 등을 관리할 수 있게 해놓았으며 각각 excel파일로 다운받을 수 있습니다.  
